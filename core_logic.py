...
# --- Configuration & Paths ---
APP_TITLE = "Фаг + АТБ подбор v9.1.1"
VERSION = "9.1.1"
LAST_CHANGES = """
Версия 9.1.1:
- Исправлены проблемы с авторизацией Git и доступом к репозиторию.
- Оптимизирована структура проекта для коммитов (настроен .gitignore).
- Обновлена документация и внутренние метаданные.
